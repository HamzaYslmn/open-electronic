...
import { T } from '../i18n'
import { Dot, Group, Oscilloscope, Param, ReadoutGrid, Schematic, Segmented, Select, SimPage, SourceControls, Theory, TRACE_COLORS, useSource, Warning } from '../ui'
...
function Diagram({ topology }: { topology: Topology }) {
  ...
  return (
    <Schematic viewBox="0 0 275 178" label="rectifier.rectifier">
      {topology === 'half' && (
        <>
          <Winding x={40} y={85} />
